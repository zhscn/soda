(library (soda packages buffer-ui)
  (export make-mode-spec mode-spec? mode-spec-id mode-spec-kind
          ...
          buffer-input-layers-facet buffer-edit-policies-facet
          buffer-read-only-option buffer-read-only-facet
          buffer-read-only-compartment buffer-read-only?
          buffer-display-profile-facet buffer-item-ranges-facet
          ...
          make-buffer-item buffer-item? buffer-item-provider-id buffer-item-id
          buffer-item-kind buffer-item-payload buffer-item-actions
          buffer-item-primary-action buffer-item-field buffer-item-field-extension
          make-buffer-items-effect make-projection-update projection-update?
          ...
          make-semantic-position semantic-position? semantic-position-provider-id
          semantic-position-item-id semantic-position-offset-within-item
