(library (soda packages window)
  ...
  (define (make-window-service! host owner)
    ...
    (let* ([runtime (package-host-command-runtime host)]
      ...
      (define-command
        runtime owner 'window.split-below (context)
        ...
        (command-handled))
      (define-command
        runtime owner 'window.split-right (context)
        ...
        (command-handled))
      (define-command
        runtime owner 'window.other (context)
